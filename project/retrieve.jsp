...
PreparedStatement ps=con.prepareStatement("select * from doctorrec where name=? and Password=? ");
...
if(status){
%>
<center> Hi there,<%=rs.getString(1)%> </center>
<a href="signIn.html"> Logout </a><br><br>
